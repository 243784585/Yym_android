...
public abstract class BaseListFragment1<T extends BaseEnitity> extends BaseWorkerFragment implements OnItemClickListener, OnItemLongClickListener {
    ...
    protected void initViewData(View view) {
        ...
        this.prlv_details = (PullToRefreshListView) view.findViewById(this.getPullToRefreshListViewResouceId());
