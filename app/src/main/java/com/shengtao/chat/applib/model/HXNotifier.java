 ...
 */
package com.shengtao.chat.applib.model;
...
public class HXNotifier {
    ...
    protected void sendNotification(EMMessage message, boolean isForeground, boolean numIncrease) {
        ...
        try {
            ...
            String appname = (String) packageManager.getApplicationLabel(appContext.getApplicationInfo());//一大帮
            ...
            Bitmap bitmap = BitmapFactory.decodeResource(appContext.getResources(), R.drawable.ic_launcher);//SerializableUtil.drawableToBitmap(drawable);
            ...
            mBuilder.setContentText("您有新消息");
            mBuilder.setContentIntent(pendingIntent);
            mBuilder.setNumber(notificationNum);
            Notification notification = mBuilder.build();
//            Notification notification = new Notification(R.drawable.ic_sure,"新消息1",System.currentTimeMillis());
//
//            notification.icon = R.drawable.ic_launcher;
//            notification.setLatestEventInfo(appContext,"新消息1", "您有新消息1111", pendingIntent);
            if (isForeground) {
//                notificationManager.notify(R.drawable.ic_sure, notification);
    ...
    public void viberateAndPlayTone(EMMessage message) {
        ...
        try {
            ...
            if (audioManager.getRingerMode() == AudioManager.RINGER_MODE_SILENT) {
                EMLog.e(TAG, "in slient mode now,现在处于静音模式");
                return;
            }
