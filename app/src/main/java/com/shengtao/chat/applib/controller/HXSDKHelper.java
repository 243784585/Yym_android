 ...
 */
package com.shengtao.chat.applib.controller;
...
import com.shengtao.chat.applib.model.DefaultHXSDKModel;
 ...
 *
 * 开发人员可以选择继承这个环信SDK帮助类去加快初始化集成速度。此类会初始化环信SDK，
 * 并设置初始化参数和初始化相应的监听器
 * 不过继承类需要根据要求求提供相应的函数，尤其是提供一个{@link HXSDKModel}.
 * 所以请实现abstract protected HXSDKModel createModel();
...
public abstract class HXSDKHelper {
    ...
    protected HXNotificationInfoProvider getNotificationListener(){
        //return null;
        return  new tempHXNotificationInfoProvider();
    }
    class tempHXNotificationInfoProvider implements HXNotificationInfoProvider {
        public tempHXNotificationInfoProvider(){}
