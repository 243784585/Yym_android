...
import com.shengtao.chat.chatUI.adapter.NewFriendsMsgAdapter;
...
public class NewFriendsMsgActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		UIApplication.getContext().getContactList().get(Constant.NEW_FRIENDS_USERNAME).setUnreadMsgCount(0);
