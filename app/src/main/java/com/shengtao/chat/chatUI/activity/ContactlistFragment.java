...
import com.shengtao.chat.applib.controller.HXSDKHelper.HXSyncListener;
import com.shengtao.chat.chatUI.Constant;
import com.shengtao.chat.chatUI.adapter.ContactAdapter;
...
import com.shengtao.chat.chatUI.widget.Sidebar;
...
public class ContactlistFragment extends Fragment {
	...
	private void getContactList() {
		contactList.clear();
		//获取本地好友列表
		Map<String, User> users = UIApplication.getContext().getContactList();
