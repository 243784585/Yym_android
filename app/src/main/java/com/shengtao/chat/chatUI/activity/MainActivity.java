...
import com.shengtao.chat.chatUI.domain.InviteMessage.InviteMesageStatus;
...
public class MainActivity extends BaseActivity implements EMEventListener {
	...
	protected static final String TAG = "PicturesBoxActivity";
	// 未读消息textview
...
//		registerInternalDebugReceiver();
	...
	public int getUnreadAddressCountTotal() {
		...
		if (UIApplication.getContext().getContactList().get(Constant.NEW_FRIENDS_USERNAME) != null)
			unreadAddressCountTotal = UIApplication.getContext().getContactList().get(Constant.NEW_FRIENDS_USERNAME)
					.getUnreadMsgCount();
	...
	public class MyContactListener implements EMContactListener {
		...
		public void onContactAdded(List<String> usernameList) {
			// 保存增加的联系人
			Session.SetBoolean("redmsg",true);
			Map<String, User> localUsers = UIApplication.getContext()
					.getContactList();
		...
		public void onContactDeleted(final List<String> usernameList) {
			// 被删除
			Map<String, User> localUsers = UIApplication.getContext().getContactList();
			for (String username : usernameList) {
		...
		public void onDisconnected(final int error) {
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
					...
					Message msg = com.shengtao.main.MainActivity.mHandler1.obtainMessage();
					com.shengtao.main.MainActivity.mHandler1.sendMessage(msg);
					finish();
...
//				UIApplication.getContext().logout(new EMCallBack() {
//					@Override
//					public void onSuccess() {
//						runOnUiThread(new Runnable() {
//							public void run() {
