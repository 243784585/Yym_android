		...
		((DemoHXSDKHelper) HXSDKHelper.getInstance()).getUserProfileManager().asyncGetUserInfo(username, new EMValueCallBack<User>() {
			...
			public void onSuccess(User user) {
				if (user != null) {
					...
					ImageLoader.getInstance().displayImage(user.getAvatar(),headAvatar, UIApplication.getAvatar());
//					if(!TextUtils.isEmpty(user.getAvatar())){
//						Image
//						 Picasso.with(UserProfileActivity.this).load().placeholder(R.drawable.default_avatar).into(headAvatar);
//					}else{
