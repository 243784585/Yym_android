...
import com.shengtao.BuildConfig;
import com.shengtao.R;
import com.shengtao.chat.chatUI.domain.VideoEntity;
import com.shengtao.chat.chatUI.util.ImageResizer;
import com.shengtao.chat.chatUI.util.Utils;
import com.shengtao.chat.chatUI.widget.RecyclingImageView;

import java.util.ArrayList;
import java.util.List;

import static com.shengtao.chat.chatUI.util.ImageCache.ImageCacheParams;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageResizer.setLoadingImage(R.drawable.ic_empty);
