 ...
 */
package com.shengtao.chat.chatUI;
...
import com.shengtao.chat.applib.model.HXNotifier;
import com.shengtao.chat.applib.model.HXNotifier.HXNotificationInfoProvider;
import com.shengtao.chat.applib.model.HXSDKModel;
import com.shengtao.chat.chatUI.activity.ChatActivity;
import com.shengtao.chat.chatUI.activity.MainActivity;
import com.shengtao.chat.chatUI.activity.VideoCallActivity;
import com.shengtao.chat.chatUI.activity.VoiceCallActivity;
import com.shengtao.chat.chatUI.domain.RobotUser;
import com.shengtao.chat.chatUI.domain.User;
import com.shengtao.chat.chatUI.receiver.CallReceiver;
        ...
        return new HXNotificationInfoProvider() {
            ...
            public Intent getLaunchIntent(EMMessage message) {
                ...
                if (chatType == ChatType.Chat){
                    Session.SetBoolean("msgred", true);
                    Session.SetBoolean("msgredfriend", true);
//                     intent = new Intent(appContext, MyFriendsDetailsActivity.class);
//                    intent.putExtra("type","1");
//                    intent.putExtra("user_id", message.getStringAttribute("ID",null));

                }else {
                    int ID=Integer.valueOf(message.getStringAttribute("ID",null));
//                    Session.SetBoolean("msgredmore",true);
//                    intent = new Intent(appContext, GroupDetailActivity.class);
//                    intent.putExtra("group_id",ID);
//                    intent.putExtra("g_name", "一大帮");
                }
