...
import com.shengtao.chat.applib.model.GroupRemoveListener;
import com.shengtao.chat.chatUI.DemoHXSDKHelper;
import com.shengtao.chat.chatUI.adapter.ExpressionAdapter;
import com.shengtao.chat.chatUI.adapter.ExpressionPagerAdapter;
import com.shengtao.chat.chatUI.adapter.MessageAdapter;
import com.shengtao.chat.chatUI.adapter.VoicePlayClickListener;
import com.shengtao.chat.chatUI.domain.RobotUser;
...
import com.shengtao.chat.chatUI.widget.ExpandGridView;
import com.shengtao.chat.chatUI.widget.PasteEditText;
import com.shengtao.domain.MumberList;
...
public class ChatActivity extends BaseActivity implements OnClickListener, EMEventListener{
	...
	public static String currueUserImgUrl;
	public static  ArrayList<MumberList> mumberList;
	public static String friendsImgUrl;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//获取头像的url
		currueUserImgUrl=Session.GetString("headimg");

		mumberList=new ArrayList<MumberList>();
		if (chatType == CHATTYPE_SINGLE){
//			friendsImgUrl=getIntent().getStringExtra("friendsUrl");
			ID=getIntent().getStringExtra("ID");
			ToId=getIntent().getStringExtra("toId");
		}
		else{
			mumberList=(ArrayList<MumberList>)getIntent().getSerializableExtra("mumber");
			ID=getIntent().getStringExtra("ID");
		}
	...
	protected void loadChatFace(boolean isloading){
		//
		if(isloading){
...
//					UserUtils.setUserNick(getIntent().getStringExtra("friendsName"), (TextView) findViewById(R.id.name));
	...
	public void selectPicFromCamera() {
		...
		cameraFile = new File(PathUtil.getInstance().getImagePath(), UIApplication.getContext().getUserName()
...
//			message.setAttribute("queueName","嗨抢客服组");
			if(isRobot){
			...
			//adapter.setUserImg(currueUserImgUrl);
			adapter.refreshSelectLast();
...
//			 sendVoiceSub(filePath, fileName, message);
				...
				try {
					...
					if (buttonSetModeKeyboard.getVisibility() != View.VISIBLE) {
						...
						if (filename != "delete_expression") { // 不是删除键，显示表情
							...
							Class clz = Class.forName("com.shengtao.chat.chatUI.utils.SmileUtils");
	...
	protected void onResume() {
		...
		// register the event listener when enter the foreground /注册回调？
