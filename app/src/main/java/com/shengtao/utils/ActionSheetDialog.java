...
public class ActionSheetDialog {
	 ...
	 * @return
	 */
	public ActionSheetDialog addSheetItem(int resouceId, String strItem, SheetItemColor color, OnSheetItemClickListener listener) {
		if (sheetItemList == null) {
			sheetItemList = new ArrayList<SheetItem>();
		}
		sheetItemList.add(new SheetItem(resouceId, strItem, color, listener));
		return this;
	}
	...
	private void setSheetItems() {
		...
		for (int i = 1; i <= size; i++) {
			...
			// 设置最外层布LinearLayout的宽度与高度，以及布局水平显示
			LayoutParams params = new LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT, height);
			...
			// 设置图片URI
			imgView.setImageResource(sheetItem.resouceId);
			LayoutParams imageParams = new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
//			imageParams.setMargins(20, 0, 0, 0);
	...
	public class SheetItem {
		...
		public SheetItem(int resouceId, String name, SheetItemColor color, OnSheetItemClickListener itemClickListener) {
